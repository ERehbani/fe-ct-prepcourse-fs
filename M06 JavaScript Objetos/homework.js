...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   var cuenta = {nombre, email, password}
   return cuenta;
}
...
function tienePropiedad(objeto, propiedad) {
   ...
   // !! convierte una sentencia en un booleano
   // return (!!objecto[propiedad])
...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   for (let user of objetoMuchosUsuarios){
      user.esPremium = true;                       // El for in busca el indice mientras que el for of busca el objeto
   }
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // objetoUsuario.posts.forEach((post) => (totalLikes = post.likes + totalLikes));
